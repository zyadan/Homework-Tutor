...
TableStore.decoder = {
    ...
    decodeGetRow: function (buffers) {
        return TableStore.decoder._decodeRowResponse(buffers, tsProtos.GetRowResponse);
    },
    decodePutRow: function (buffers) {
        return TableStore.decoder._decodeRowResponse(buffers, tsProtos.PutRowResponse);
    },
    decodeUpdateRow: function (buffers) {
        return TableStore.decoder._decodeRowResponse(buffers, tsProtos.UpdateRowResponse);
    },
    decodeDeleteRow: function (buffers) {
        return TableStore.decoder._decodeRowResponse(buffers, tsProtos.DeleteRowResponse);
    },
    _decodeRowResponse: function (buffers, responseType) {
        var returnResp = {};
        var response = responseType.decode(buffers);
        returnResp.consumed = response.consumed;
        returnResp.row = TableStore.decoder._parseRowItem(response.row);
        return returnResp;
    },
