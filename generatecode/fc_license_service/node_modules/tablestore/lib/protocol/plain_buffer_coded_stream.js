...
TableStore.PlainBufferCodedOutputStream = inherit({
    ...
    writePrimaryKey: function (primaryKeys, rowCheckSum) {
        if (!(primaryKeys instanceof Array)) {
            throw new Error("Invalid primaryKey, the type of primaryKey should be array.");
        }
    ...
    writeColumns: function (columns, rowCheckSum) {
        if (!(columns instanceof Array)) {
            throw new Error("Invalid attributeColumns, the type of attributeColumns should be array.");
        }
    ...
    writeUpdateColumns: function (attributeColumns, rowCheckSum) {
        if (!(attributeColumns instanceof Array)) {
            throw new Error("Invalid attributeColumns, the type of attributeColumns should be array.");
        }
